...
struct FAINearbyPlayer
{
	...
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0080(0x0010)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0090(0x0010)
};
...
{
	struct FAIPlayerState                              State;                                                    // 0x0000(0x0080)
	struct FAIHeardSound                               Sound;                                                    // 0x0080(0x0010)
	struct FAIDamageSources                            damage_sources;                                           // 0x0090(0x0030)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x00C0(0x0030)
	struct FCameraState                                Camera;                                                   // 0x00F0(0x0024)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0114(0x0004) MISSED OFFSET
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0118(0x0010)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x0128(0x0010)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0138(0x0010)
	struct FProgressBarState                           progress_bar;                                             // 0x0148(0x0020)
	TArray<struct FAINearbyPlayer>                     nearby_player;                                            // 0x0168(0x0010) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x0178(0x0010) (ZeroConstructor)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x0188(0x0010) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0198(0x0010) (ZeroConstructor)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x01A8(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x01B8(0x0014)
	struct FSafetyAreaState                            safety_area;                                              // 0x01CC(0x002C)
	struct FRedZoneState                               red_zone;                                                 // 0x01F8(0x0018)
	struct FAIGameState                                Game;                                                     // 0x0210(0x0010)
	uint32_t                                           Key;                                                      // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           deliver_target_id;                                        // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVehicleState                               vehicle_state;                                            // 0x0228(0x0078)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x02A0(0x0010) (ZeroConstructor)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x02B0(0x0020)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x02D0(0x0010) (ZeroConstructor)
	TArray<struct FSpecialZoneState>                   special_zones;                                            // 0x02E0(0x0010) (ZeroConstructor)
	uint32_t                                           ai_style;                                                 // 0x02F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02F4(0x0004) MISSED OFFSET
	TArray<struct FString>                             IgnoreNames;                                              // 0x02F8(0x0010) (ZeroConstructor)
};
...
struct FDiffAIPlayerState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoBool                          is_pose_acting;                                           // 0x0072(0x0001)
	struct FDiffStateInfoBool                          is_picking;                                               // 0x0073(0x0001)
...
{
	struct FDiffAIPlayerState                          State;                                                    // 0x0010(0x0088)
	struct FDiffAIPlayerWeapon                         Weapon;                                                   // 0x0098(0x0030)
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x00C8(0x0030)
};
...
// 0x0410 (0x0420 - 0x0010)
struct FDiffAIStateInfo : public FDiffStateInfoBase
{
	struct FDiffAIPlayerState                          State;                                                    // 0x0010(0x0088)
	struct FAIHeardSound                               Sound;                                                    // 0x0098(0x0010)
	struct FDiffCameraState                            Camera;                                                   // 0x00A8(0x0038)
	struct FDiffAIPlayerWeapon                         Weapon;                                                   // 0x00E0(0x0030)
	struct FDiffPlayerBackpack                         BackPack;                                                 // 0x0110(0x0030)
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x0140(0x0030)
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0170(0x0018)
	struct FDiffAINearbyPlayers                        nearby_player;                                            // 0x0188(0x0030)
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x01B8(0x0030)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x01E8(0x0010) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x01F8(0x0010) (ZeroConstructor)
	struct FDiffSafetyAreaState                        safety_area;                                              // 0x0208(0x0040)
	struct FDiffAIGameState                            Game;                                                     // 0x0248(0x0018)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0260(0x0010) (ZeroConstructor)
	struct FDiffRedZoneState                           red_zone;                                                 // 0x0270(0x0028)
	struct FAIDamageSources                            damage_sources;                                           // 0x0298(0x0030)
	uint32_t                                           Key;                                                      // 0x02C8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x02CC(0x0004) MISSED OFFSET
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x02D0(0x0010) (ZeroConstructor)
	struct FDiffVehicleState                           vehicle_state;                                            // 0x02E0(0x0090)
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x0370(0x0030)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x03A0(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x03B0(0x0014)
	unsigned char                                      UnknownData01[0x4];                                       // 0x03C4(0x0004) MISSED OFFSET
	struct FAIBulletHoles                              bullet_holes;                                             // 0x03C8(0x0020)
	struct FDiffSpecialZone                            special_zone;                                             // 0x03E8(0x0030)
	uint32_t                                           ai_style;                                                 // 0x0418(0x0004) (ZeroConstructor, IsPlainOldData)
