...
struct FUTSkillCreateData
{
	...
	TArray<struct FName>                               AsyncLoadingSkillUI;                                      // 0x0050(0x0010) (ZeroConstructor, Transient)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0060(0x0010) (ExportObject, ZeroConstructor, Transient)
};
...
struct FUTSkillInstance
{
	...
	TArray<TEnumAsByte<EUTSkillEventType>>             EventCache;                                               // 0x0028(0x0010) (ZeroConstructor)
	class UUAEBlackboard*                              Blackboard;                                               // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FUTSkillCreateData                          SkillBaseData;                                            // 0x0040(0x0070)
	TWeakObjectPtr<class AUTSkill>                     Skill;                                                    // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillWidget>               SkillWidget;                                              // 0x00B8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillManagerComponent>     OwnerComp;                                                // 0x00C0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
