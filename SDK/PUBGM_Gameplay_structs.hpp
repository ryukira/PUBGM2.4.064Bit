...
struct FGameModePlayerBattleResultData
{
	...
	uint32_t                                           DeadCircleIndex;                                          // 0x0068(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ShootWeaponShotNum;                                       // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ShootWeaponShotAndHitPlayerNum;                           // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ShootWeaponShotAndHitPlayerNumNoAI;                       // 0x0074(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ShootWeaponShotHeadNum;                                   // 0x0078(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ShootWeaponShotHeadNumNoAI;                               // 0x007C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HealTimes;                                                // 0x0080(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0084(0x0004) MISSED OFFSET
	TArray<struct FString>                             KillFlow;                                                 // 0x0088(0x0010) (ZeroConstructor)
	TArray<struct FString>                             KnockOutFlow;                                             // 0x0098(0x0010) (ZeroConstructor)
...
struct FGameModePlayerParams
{
	...
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x01A0(0x0030)
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x01D0(0x0020)
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x01F0(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x0200(0x0010) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x0210(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x0214(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x0218(0x0010) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x0228(0x0018)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x0240(0x0018)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x0258(0x0010) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x0268(0x000C)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0274(0x0004) MISSED OFFSET
	TArray<int>                                        audioChat;                                                // 0x0278(0x0010) (ZeroConstructor)
	struct FName                                       CurrentPlayerState;                                       // 0x0288(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       CurrentCharacterState;                                    // 0x0290(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              SyncedTimestamp;                                          // 0x0298(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x029C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WarmScore;                                                // 0x02A0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AIAllocMarkValue;                                         // 0x02A4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LeaderCount;                                              // 0x02A8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x02AC(0x0004) MISSED OFFSET
	uint64_t                                           LastGameLeaderUID;                                        // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   LastGameTeammatesUID;                                     // 0x02B8(0x0010) (ZeroConstructor)
	uint64_t                                           LastGameBattleID;                                         // 0x02C8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              RatingScore;                                              // 0x02D0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDoPlayerUseAutoFollow;                                   // 0x02D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x02D5(0x0003) MISSED OFFSET
	float                                              MaxRankingScore;                                          // 0x02D8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ObserverFlags;                                            // 0x02DC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           WatchPlayerKey;                                           // 0x02E0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsHawkEyeSpectator;                                      // 0x02E8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x02E9(0x0003) MISSED OFFSET
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x02EC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x02F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlatformGender;                                           // 0x02F4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x02F5(0x0003) MISSED OFFSET
	int                                                planeAvatarId;                                            // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x02FC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Nation;                                                   // 0x0300(0x0010) (ZeroConstructor)
	int                                                MatchLabel;                                               // 0x0310(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatColorID;                                        // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatResID;                                          // 0x0318(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyTeammateSeeAvatar;                                    // 0x031C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x031D(0x0003) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x0320(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CorpsID;                                                  // 0x0328(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CampID;                                                   // 0x0330(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x0338(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0339(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x033A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x5];                                       // 0x033B(0x0005) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0340(0x0010) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0350(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x3];                                       // 0x0351(0x0003) MISSED OFFSET
	int                                                VeteranRecruitIndex;                                      // 0x0354(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MatchStrategyLabel;                                       // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x4];                                       // 0x035C(0x0004) MISSED OFFSET
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0360(0x0010) (ZeroConstructor)
	int                                                LandId;                                                   // 0x0370(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowType;                                               // 0x0374(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           FollowUID;                                                // 0x0378(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x0380(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x0384(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData17[0x4];                                       // 0x0394(0x0004) MISSED OFFSET
};
...
struct FGameModeAIPlayerParams : public FGameModePlayerParams
{
	...
	uint32_t                                           AILevel;                                                  // 0x0398(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x039C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x039D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x039E(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x03A0(0x0004) (ZeroConstructor, IsPlainOldData)
