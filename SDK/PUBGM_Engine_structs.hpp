...
struct FAnimNode_AnimInstanceContainer : public FAnimNode_Base
{
	...
	struct FPoseLink                                   InPose;                                                   // 0x0040(0x0018) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x30];                                      // 0x0058(0x0030) MISSED OFFSET
	class UAnimInstance*                               ParentAnimInstance;                                       // 0x0088(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UAnimInstance*                               CurrentAnimInstance;                                      // 0x0090(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FWorldRegionManager
{
	...
	unsigned char                                      UnknownData01[0x68];                                      // 0x01A0(0x0068) MISSED OFFSET
};
