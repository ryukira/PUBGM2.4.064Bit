...
public:
	...
	bool                                               bNeedSync;                                                // 0x03D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x03D1(0x0007) MISSED OFFSET
	struct FString                                     SkillName;                                                // 0x03D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	int                                                SkillID;                                                  // 0x03F4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkillTemplateID;                                          // 0x03F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x03FC(0x0004) MISSED OFFSET
	struct FString                                     SkillDescription;                                         // 0x0400(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     SkillDetailDes;                                           // 0x0410(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bMeleeSkill;                                              // 0x0420(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCheckFirstPhaseConditions;                               // 0x0421(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNeedAutonomousClientSimulate;                            // 0x0422(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bKeepCastingWhenDisconnect;                               // 0x0423(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bClearInputCache;                                         // 0x0424(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0425(0x0003) MISSED OFFSET
	struct FUTSkillCreateData                          BaseData;                                                 // 0x0428(0x0070) (Edit, BlueprintVisible)
	int                                                SkillCategory;                                            // 0x0498(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseNewSkillCD;                                           // 0x049C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x049D(0x0003) MISSED OFFSET
	TArray<struct FUAEBlackboardParameter>             BlackboardParamList;                                      // 0x04A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bSetBlackboardDefaultData;                                // 0x04B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bGsListener;                                              // 0x04B1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x6];                                       // 0x04B2(0x0006) MISSED OFFSET
	struct FString                                     SkillTimeScaleAttrName;                                   // 0x04B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x04C8(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x0518(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x051C(0x0004) MISSED OFFSET
	TArray<struct FString>                             ParentFolderPath;                                         // 0x0520(0x0010) (ZeroConstructor)
	int64_t                                            LastEditBluePrintTime;                                    // 0x0530(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                CurComponentNameIndex;                                    // 0x0538(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsSkillEnabled;                                           // 0x053C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x53];                                      // 0x053D(0x0053) MISSED OFFSET
	TWeakObjectPtr<class UUTSkillManagerComponent>     SpecificSkillCompRef;                                     // 0x0590(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUAEBlackboard>               SpecificBlackBlackRef;                                    // 0x0598(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TMap<TWeakObjectPtr<class AUTSkill>, class UUAEBlackboard*> SkillsBlackboardMap;                                      // 0x02C0(0x0050) (ZeroConstructor)
	...
	class AActor*                                      Target;                                                   // 0x0370(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TMap<int, struct FUTSkillCreateData>               SkillBaseDataMaps;                                        // 0x0378(0x0050) (ZeroConstructor)
	TArray<struct FUTSkillLastCastInfo>                LastCastArray;                                            // 0x03C8(0x0010) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillHit;                                               // 0x03D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSkillCast;                                              // 0x03E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	float                                              PhasePercentage;                                          // 0x03F8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x03FC(0x0004) MISSED OFFSET
	TMap<int, int>                                     IDToSyncSkillActiveStateData;                             // 0x0400(0x0050) (ZeroConstructor)
	TArray<struct FSkillActiveRepData>                 SyncSkillActiveStateDatas;                                // 0x0450(0x0010) (Net, ZeroConstructor)
	TMap<int, int>                                     IDToSyncSkillCDDatas;                                     // 0x0460(0x0050) (ZeroConstructor)
	struct FTeammateSkillCDRepData                     TeammateSkillCDRepData;                                   // 0x04B0(0x0010)
	...
	unsigned char                                      UnknownData06[0x4];                                       // 0x0558(0x0004) MISSED OFFSET
	int                                                SkillSynRandomSeed;                                       // 0x055C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRandomStream                               SkillSynRandStream;                                       // 0x0560(0x0008)
	int                                                SkillSynRandomSeedExpireCount;                            // 0x0568(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x056C(0x0004) MISSED OFFSET
	TMap<struct FString, struct FTimerHandle>          SkillTimerMap;                                            // 0x0570(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x8];                                       // 0x05C0(0x0008) MISSED OFFSET
	TArray<struct FSkillParamater>                     SkillParamaters;                                          // 0x05C8(0x0010) (Net, ZeroConstructor)
	TArray<struct FUTMutilSkillSynData>                SkillSynData;                                             // 0x05D8(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	unsigned char                                      UnknownData09[0x10];                                      // 0x05E8(0x0010) MISSED OFFSET
	TArray<struct FUTSkillSynSinglePhaseData>          SkillSynSinglePhaseData;                                  // 0x05F8(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	unsigned char                                      UnknownData10[0x18];                                      // 0x0608(0x0018) MISSED OFFSET
	TMap<class AUTSkill*, int>                         SkillCurPhaseIndexes;                                     // 0x0620(0x0050) (ZeroConstructor)
	TMap<class AUTSkill*, int>                         LastPhaseIndexes;                                         // 0x0670(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData11[0x60];                                      // 0x06C0(0x0060) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x0720(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x0730(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x0740(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x0750(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x0760(0x0010) (ZeroConstructor)
	TMap<int, unsigned char>                           CurSKillLevels;                                           // 0x0770(0x0050) (ZeroConstructor, Transient)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x07C0(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	bool                                               bEnableSkillInst;                                         // 0x07D0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x7];                                       // 0x07D1(0x0007) MISSED OFFSET
	TArray<struct FUTSkillInstance>                    SkillInstArray;                                           // 0x07D8(0x0010) (ZeroConstructor)
...
public:
	...
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x0100(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     LuaFilePath;                                              // 0x0150(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	struct FString                                     LuaFilePath;                                              // 0x00C0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
