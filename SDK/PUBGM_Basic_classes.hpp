...
public:
	...
	int                                                iRegionActor;                                             // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0494(0x0002) MISSED OFFSET
	bool                                               bStaticAddNetworkActor;                                   // 0x0496(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x0497(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FClientBaseInfo                             ClientBaseInfo;                                           // 0x02A0(0x0178)
	struct FScriptMulticastDelegate                    EnginePreTick;                                            // 0x0418(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x68];                                      // 0x0428(0x0068) MISSED OFFSET
	class UFrontendHUD*                                AssociatedFrontendHUD;                                    // 0x0490(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               bStandAloneFromLobby;                                     // 0x04A8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x27];                                      // 0x04A9(0x0027) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPreBattleResult;                                        // 0x04D0(0x0010) (BlueprintVisible, ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x10];                                      // 0x04E0(0x0010) MISSED OFFSET
	TArray<struct FString>                             HighWeatherNames;                                         // 0x04F0(0x0010) (ZeroConstructor, Config)
	int                                                HighWeatherMinRenderQuality;                              // 0x0500(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                HighWeatherMaxRenderQuality;                              // 0x0504(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	struct FAttrDynamicModifier                        DynamicModifier;                                          // 0x0340(0x00A8)
	unsigned char                                      UnknownData03[0x50];                                      // 0x03E8(0x0050) MISSED OFFSET
	TArray<struct FAttributeExpand>                    AttributeExpands;                                         // 0x0438(0x0010) (Edit, ZeroConstructor)
	TMap<struct FString, struct FRelateAttributeGroup> RelateAttributeGroup;                                     // 0x0448(0x0050) (ZeroConstructor)
	EActorRegAttrTableType                             ActorAttrType;                                            // 0x0498(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10F];                                     // 0x0499(0x010F) MISSED OFFSET
	TArray<struct FModAttrSimulateSyncItem>            ModSimulateSyncList;                                      // 0x05A8(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData05[0x108];                                     // 0x05B8(0x0108) MISSED OFFSET
...
{
public:
	struct FString                                     BuffManagerBlueprintPath;                                 // 0x03C0(0x0010) (ZeroConstructor, Config)
	TArray<struct FBuffManagerModPath>                 BuffListPathMap;                                          // 0x03D0(0x0010) (ZeroConstructor, Config)
...
public:
	...
	int                                                SyncBriefNum;                                             // 0x01B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	struct FClientSyncBrief                            SyncBriefs[0x6];                                          // 0x01B8(0x0028) (Net)
	struct FClientSyncBrief                            SyncRefBriefs[0x6];                                       // 0x02A8(0x0028)
	unsigned char                                      UnknownData03[0x50];                                      // 0x0398(0x0050) UNKNOWN PROPERTY: SetProperty Basic.STBuffSystemComponent.BriefRemoveInstIds
	unsigned char                                      UnknownData04[0x120];                                     // 0x03E8(0x0120) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0DE0(0x0010) MISSED OFFSET
	class UBackendHUD*                                 AssociatedBackendHUD;                                     // 0x0DF0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0DF8(0x000C) MISSED OFFSET
	bool                                               bEnableAutoStat;                                          // 0x0E04(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableAutoTickDeltaThreshold;                            // 0x0E05(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0E06(0x0002) MISSED OFFSET
	float                                              AutoTickDeltaThresholdFactor;                             // 0x0E08(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              StatCollection_AvgTickDeltaThreshold;                     // 0x0E0C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_AvgTickDeltaThreshold;                           // 0x0E10(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_StartTime;                                       // 0x0E14(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0E18(0x0004) MISSED OFFSET
	float                                              AutoStat_Duration_Engine;                                 // 0x0E1C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_Duration_PhysX;                                  // 0x0E20(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x0E24(0x000C) MISSED OFFSET
...
// 0x0308 (0x33AC0 - 0x337B8)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0xBC];                                      // 0x337B8(0x00BC) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x33874(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x33878(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x3387C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x33880(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x33884(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x33888(0x0050) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x338D8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x338D9(0x0007) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x338E0(0x0010) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x338F0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x338F4(0x000C) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x33900(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x33904(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x33908(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x3390C(0x0004) MISSED OFFSET
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x33910(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x33960(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xE0];                                      // 0x33968(0x00E0) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x33A48(0x0010) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x33A58(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x33A5C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0xC];                                       // 0x33A60(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x33A6C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x33A6D(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x33A70(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x33A74(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x33A78(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x33A7C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x33A80(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x15];                                      // 0x33A84(0x0015) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x33A99(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x12];                                      // 0x33A9A(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x33AAC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x10];                                      // 0x33AB0(0x0010) MISSED OFFSET
