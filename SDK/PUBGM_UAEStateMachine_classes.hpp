...
{
public:
	class UUAEStateMachineComponent*                   UAEStateMachineComponent;                                 // 0x03C0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
