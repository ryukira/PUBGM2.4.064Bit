...
// 0x0068 (0x337B8 - 0x33750)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x68];                                      // 0x33750(0x0068) MISSED OFFSET
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x03C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x03CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x03E8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x03F0(0x0008) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x03F8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2F];                                      // 0x03F9(0x002F) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x03E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x03EC(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03F0(0x0010) (ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x03C0(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0458(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0468(0x0030)
	EClientRequestType                                 RequestType;                                              // 0x0498(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0499(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x049A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2D];                                      // 0x049B(0x002D) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x03E8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x03F0(0x0050) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0440(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0441(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0444(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0448(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
