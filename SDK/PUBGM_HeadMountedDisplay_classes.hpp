...
{
public:
	int                                                playerIndex;                                              // 0x0760(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EControllerHand                                    Hand;                                                     // 0x0764(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisableLowLatencyUpdate : 1;                             // 0x0765(0x0001) (Edit, BlueprintVisible)
	ETrackingStatus                                    CurrentTrackingStatus;                                    // 0x0766(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x59];                                      // 0x0767(0x0059) MISSED OFFSET
