...
public:
	...
	void OpenSlapUrl(const struct FString& URL, class UObject* __WorldContext);
	...
	void STATIC_GetOnLineColor(int onlinestate, bool bonline, class UObject* __WorldContext, struct FSlateColor* Color);
	void STATIC_UpdateNationImage(class UImage* Image, const struct FString& RoleNation, class UObject* __WorldContext);
	...
	void STATIC_OpenURL(const struct FString& URL, class UObject* __WorldContext);
