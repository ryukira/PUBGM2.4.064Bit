...
// (NetReliable, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (Exec, Native, Event, NetResponse, Static, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Event, NetResponse, Static, MulticastDelegate, Private, HasOutParms, DLLImport, BlueprintEvent)
// Parameters:
