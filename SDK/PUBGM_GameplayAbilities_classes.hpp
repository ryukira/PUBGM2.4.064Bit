...
public:
	...
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x0460(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x03C0(0x0060) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData00[0x30];                                      // 0x0420(0x0030) MISSED OFFSET
	class APlayerController*                           MasterPC;                                                 // 0x0450(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UGameplayAbility*                            OwningAbility;                                            // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyOnConfirmation;                                   // 0x0460(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0461(0x0007) MISSED OFFSET
	class AActor*                                      SourceActor;                                              // 0x0468(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x0470(0x000C) (BlueprintVisible)
	unsigned char                                      UnknownData02[0x4];                                       // 0x047C(0x0004) MISSED OFFSET
	class UClass*                                      ReticleClass;                                             // 0x0480(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x0488(0x0010) (BlueprintVisible, Net)
	bool                                               bDebug;                                                   // 0x0498(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x17];                                      // 0x0499(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x04B0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FCollisionProfileName                       TraceProfile;                                             // 0x04C0(0x0008) (Edit, BlueprintVisible, Config)
	bool                                               bTraceAffectsAimPitch;                                    // 0x04C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UMaterialInterface*                          PlacedActorMaterial;                                      // 0x0500(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FWorldReticleParameters                     Parameters;                                               // 0x03C0(0x000C) (Edit, BlueprintVisible, DisableEditOnTemplate)
	bool                                               bFaceOwnerFlat;                                           // 0x03CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSnapToTargetedActor;                                     // 0x03CD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetValid;                                           // 0x03CE(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetAnActor;                                         // 0x03CF(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x03D0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x03D8(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x03E0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x03E8(0x0010) (ExportObject, ZeroConstructor)
...
public:
	...
	TArray<class UClass*>                              LoadedGameplayCueNotifyClasses;                           // 0x0290(0x0010) (ZeroConstructor, Transient)
	TArray<class UClass*>                              GameplayCueClassesForPreallocation;                       // 0x02A0(0x0010) (ZeroConstructor, Transient)
	TArray<struct FGameplayCuePendingExecute>          PendingExecuteCues;                                       // 0x02B0(0x0010) (ZeroConstructor, Transient)
	int                                                GameplayCueSendContextCount;                              // 0x02C0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02C4(0x0004) MISSED OFFSET
	TArray<struct FPreallocationInfo>                  PreallocationInfoList_Internal;                           // 0x02C8(0x0010) (ZeroConstructor, Transient)
...
{
public:
	float                                              AutoDestroyDelay;                                         // 0x03C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfTimelineIsStillRunning;                             // 0x03C4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfLatentActionIsStillRunning;                         // 0x03C5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x03D0(0x0010) (Edit)
	...
	unsigned char                                      UnknownData02[0x34];                                      // 0x03F4(0x0034) MISSED OFFSET
