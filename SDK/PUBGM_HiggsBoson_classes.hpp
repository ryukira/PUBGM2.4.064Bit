...
// 0x0A00 (0x0BD8 - 0x01D8)
class UHiggsBosonComponent : public ULuaActorComponent
{
public:
	unsigned char                                      UnknownData00[0x110];                                     // 0x01D8(0x0110) MISSED OFFSET
	struct FString                                     TraceData;                                                // 0x02E8(0x0010) (ZeroConstructor)
	struct FString                                     GameTraceData;                                            // 0x02F8(0x0010) (ZeroConstructor)
	uint32_t                                           HeartBreaks;                                              // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x030C(0x0004) MISSED OFFSET
	struct FString                                     HeartInfo;                                                // 0x0310(0x0010) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSwiftHawkDelegate;                                      // 0x0320(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGlueHiaRayResult;                                       // 0x0330(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class ASTExtraBaseCharacter*                       CharacterOwner;                                           // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    PlayerController;                                         // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bClientInfoReceived;                                      // 0x0350(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0351(0x0007) MISSED OFFSET
	TArray<uint32_t>                                   ClientInfoAsUInt32Array;                                  // 0x0358(0x0010) (ZeroConstructor)
	TArray<unsigned char>                              IntegrityItemCheckResultAsBytes;                          // 0x0368(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x40];                                      // 0x0378(0x0040) MISSED OFFSET
	bool                                               bRoofTouchActive;                                         // 0x03B8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xB];                                       // 0x03B9(0x000B) MISSED OFFSET
	int                                                RoofTouchStatus;                                          // 0x03C4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x738];                                     // 0x03C8(0x0738) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0B00(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xD0];                                      // 0x0B08(0x00D0) MISSED OFFSET
